  ...
  return (
    <StyledContainer>
      <StyledAside>
        ...
        <StyledList>
          <Link className={css.item} to="/affiliate/user">
            ...
            <p className={css.text}>Przyłączać</p>
          </Link>
          <Link className={css.item} to="/affiliate/offer">
            <div className={css.svg}>
              <svg
                width="18"
                height="18"
            ...
            <p className={css.text}>Oferty w przygotowaniu</p>
          </Link>
          <Link className={css.item} to="/affiliate/offers">
            <div className={css.svg}>
              <svg
                width="18"
                height="18"
          ...
          <Link className={css.item} to="/affiliate/profile">
            <div className={css.svg}>
              <svg
                width="16"
                height="16"
          ...
          <Link className={css.item} to="/affiliate/balance">
            <div className={css.svg}>
              <svg
                width="20"
                height="20"
          ...
          <Link className={css.item} to="/affiliate/support">
            <div className={css.svg}>
              <svg
                width="20"
                height="20"
