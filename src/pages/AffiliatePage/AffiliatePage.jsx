      ...
      <StyledAside>
        ...
        <StyledList>
          <StyledItem to="/affiliate/user">
            ...
            <StyledItemText>Przyłączać</StyledItemText>
          </StyledItem>
          <StyledItem to="/affiliate/offer">
            ...
            <StyledItemText>Oferty w przygotowaniu</StyledItemText>
          </StyledItem>
          <StyledItem to="/affiliate/offers">
            <StyledWrapperSvg>
              <svg
                width="18"
                height="18"
          ...
          <StyledItem to="/affiliate/profile">
            <StyledWrapperSvg>
              <svg
                width="16"
                height="16"
          ...
          <StyledItem to="/affiliate/balance">
            <StyledWrapperSvg>
              <svg
                width="20"
                height="20"
          ...
          <StyledItem to="/affiliate/support">
            <StyledWrapperSvg>
              <svg
                width="20"
                height="20"
            ...
            <StyledItemText>Pomoc techniczna</StyledItemText>
          </StyledItem>
        </StyledList>
      </StyledAside>
      <StyledWrapperSection>
