...
import css from './ManagerPage.module.css';
  ...
  return (
    <StyledContainer>
      <StyledAside>
        ...
        <StyledList>
          <Link className={css.item} to="/manager/user">
            ...
            <p className={css.text}>Menedżer</p>
          </Link>
          <Link className={css.item} to="/manager/users">
            <div className={css.svg}>
              <svg
                className={css.svg1}
                width="20"
            ...
            <p className={css.text}>Użytkownicy</p>
          </Link>
          <Link className={css.item} to="/manager/offers">
            <div className={css.svg}>
              <svg
                width="18"
                height="18"
          ...
          <Link className={css.item} to="/manager/profile">
            <div className={css.svg}>
              <svg
                width="16"
                height="16"
          ...
          <Link className={css.item} to="/manager/balance">
            <div className={css.svg}>
              <svg
                width="20"
                height="20"
          ...
          <Link className={css.item} to="/manager/support">
            <div className={css.svg}>
              <svg
                width="20"
                height="20"
